...
def load_excel_datasets():
    ...
    if os.path.exists(symptoms_path):
        ...
        print("   📁 File: medical_symptoms_small.xlsx")
    ...
    if os.path.exists(patients_path):
        ...
        print("   📁 File: patient_records_small.xlsx")
...
def load_csv_datasets():
    ...
    if os.path.exists(abstracts_path):
        ...
        print("   📁 File: medical_abstracts_medium.csv")
    ...
    if os.path.exists(trials_path):
        ...
        print("   📁 File: clinical_trials_medium.csv")
        print(f"   📋 Total Rows: {full_count}")
...
def generate_summary():
    ...
    for filename, file_type, size_cat in files:
        ...
        if os.path.exists(filepath):
            ...
            print(f"   📄 {filename}")
            print(
                f"      Type: {file_type} | Size: {size_cat} | {file_size / 1024 / 1024:.2f} MB"
            )

    print(f"\n📊 Total Dataset Size: {total_size / 1024 / 1024:.2f} MB")
    print("🎯 Ready for RAG-Anything integration!")
